...
InstrData InstrDataTable[256] = {
    // Opcode Mnemonic Name Mode           Illegal Cycles PageCycles UpdatesOperand Description
    /* 0x00 */ { "BRK",     Addr_Implicit, false,  7,     0,         false,         "Force Break" },
    /* 0x01 */ { "ORA",     Addr_IndirX,   false,  6,     0,         false,          "Or Memory with Accumulator" }, 
    /* 0x02 */ { "HLT*",    Addr_Illegal,  true,   0,     0,         false,          "Illegal" },
    /* 0x03 */ { "ASO*",    Addr_IndirX,   true,   8,     0,         false,          "Illegal" },
    /* 0x04 */ { "TSB", Addr_ZeroPage,    false, 5,     0,           false,          "Test and Set Memory Bits" },
    ...
    /* 0x07 */ { "ASO*", Addr_ZeroPage,    true,  5,     0,          false,          "Illegal" },
    ...
    /* 0x0B */ { "ANC*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    /* 0x0C */ { "SKW*", Addr_Absolute,    true,  4,     0,          false,          "Illegal" },
    ...
    /* 0x0F */ { "ASO*", Addr_Absolute,    true,  6,     0,          false,          "Illegal" },
    /* 0x10 */ { "BPL", Addr_Relative,    false, 2,     1,           false,          "Branch if Positive" },
    /* 0x11 */ { "ORA", Addr_IndirY,      false, 5,     1,           false,           "Or Memory with Accumulator" },
    /* 0x12 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0x13 */ { "ASO*", Addr_IndirY,      true,  8,     0,          false,          "Illegal" },
    /* 0x14 */ { "SKB*", Addr_ZeroPageX,   true,  4,     0,          false,          "Illegal" },
    ...
    /* 0x17 */ { "ASO*", Addr_ZeroPageX,   true,  6,     0,          false,          "Illegal" },
    ...
    /* 0x1B */ { "ASO*", Addr_AbslY,       true,  7,     0,          false,          "Illegal" },
    /* 0x1C */ { "SKW*", Addr_AbslX,       true,  4,     1,          false,          "Illegal" },
    /* 0x1D */ { "ORA", Addr_AbslX,       false, 4,     1,           false,           "Or Memory with Accumulator" },
    /* 0x1E */ { "ASL", Addr_AbslX,       false, 7,     0,           true,           "Arithmetic Shift Left" },
    /* 0x1F */ { "SKW*", Addr_AbslX,       true,  7,     0,          false,          "Illegal" },
    ...
    /* 0x22 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    ...
    /* 0x2B */ { "ANC*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0x32 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0x33 */ { "RLA*", Addr_IndirY,      true,  8,     0,          false,          "Illegal" },
    /* 0x34 */ { "SKB*", Addr_ZeroPageX,   true,  4,     0,          false,          "Illegal" },
    ...
    /* 0x3C */ { "SKW*", Addr_AbslX,       true,  4,     1,          false,          "Illegal" },
    ...
    /* 0x42 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0x43 */ { "LSE*", Addr_IndirX,      true,  8,     0,          false,          "Illegal" },
    /* 0x44 */ { "SKB*", Addr_ZeroPage,    true,  3,     0,          false,          "Illegal" },
    ...
    /* 0x47 */ { "LSE*", Addr_ZeroPage,    true,  5,     0,          false,          "Illegal" },
    ...
    /* 0x4B */ { "ALR*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0x4F */ { "LSE*", Addr_Absolute,    true,  6,     0,          false,          "Illegal" },
    ...
    /* 0x52 */ { "HLT*", Addr_Illegal,     true, 0,     0,           false,          "Illegal" },
    /* 0x53 */ { "LSE*", Addr_IndirY,      true, 8,     0,           false,          "Illegal" },
    /* 0x54 */ { "SKB*", Addr_ZeroPageX,   true, 4,     0,           false,          "Illegal" },
    ...
    /* 0x57 */ { "LSE*", Addr_ZeroPageX,   true,  6,     0,          false,          "Illegal" },
    ...
    /* 0x5B */ { "LSE*", Addr_AbslY,       true,  7,     0,          false,          "Illegal" },
    /* 0x5C */ { "SKW*", Addr_AbslX,       true,  4,     1,          false,          "Illegal" },
    ...
    /* 0x5F */ { "LSE*", Addr_AbslX,       true,  7,     0,          false,          "Illegal" },
    ...
    /* 0x62 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0x63 */ { "RRA*", Addr_IndirX,      true,  8,     0,          false,          "Illegal" },
    /* 0x64 */ { "SKB*", Addr_ZeroPage,    true,  3,     0,          false,          "Illegal" },
    ...
    /* 0x6B */ { "ARR*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0x72 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0x73 */ { "RRA*", Addr_IndirY,      true,  8,     0,          false,          "Illegal" },
    /* 0x74 */ { "SKB*", Addr_ZeroPageX,   true,  4,     0,          false,          "Illegal" },
    ...
    /* 0x7C */ { "SKW*", Addr_AbslX,       true,  4,     1,          false,          "Illegal" },
    ...
    /* 0x80 */ { "SKB*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    /* 0x81 */ { "STA", Addr_IndirX,      false, 6,     0,           false,           "Store Accumulator in Memory" },
    /* 0x82 */ { "SKB*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0x89 */ { "SKB*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    /* 0x8A */ { "TXA", Addr_Implicit,    false, 2,     0,           false,          "Transfer Index X to Accumulator" },
    /* 0x8B */ { "ANE*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0x92 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0x93 */ { "SHA*", Addr_IndirY,      true,  6,     0,          false,          "Illegal" },
    ...
    /* 0x9B */ { "SHS*", Addr_AbslY,       true,  5,     0,          false,          "Illegal" },
    /* 0x9C */ { "SHY*", Addr_AbslX,       true,  5,     0,          false,          "Illegal" },
    /* 0x9D */ { "STA", Addr_AbslX,       false, 5,     0,           false,           "Store Accumulator in Memory" },
    /* 0x9E */ { "SHX*", Addr_AbslY,       true,  5,     0,          false,          "Illegal" },
    /* 0x9F */ { "SHA*", Addr_AbslY,       true,  5,     0,          false,          "Illegal" },
    ...
    /* 0xAB */ { "ANX*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0xB2 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    ...
    /* 0xBB */ { "LAS*", Addr_AbslY,       true,  4,     1,          false,          "Illegal" },
    ...
    /* 0xC2 */ { "SKB*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    /* 0xC3 */ { "DCM*", Addr_IndirX,      true,  8,     0,          false,          "Illegal" },
    ...
    /* 0xC7 */ { "DCM*", Addr_ZeroPage,    true,  5,     0,          false,          "Illegal" },
    ...
    /* 0xCB */ { "SBX*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    ...
    /* 0xCF */ { "DCM*", Addr_Absolute,    true,  6,     0,          false,          "Illegal" },
    ...
    /* 0xD2 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0xD3 */ { "DCM*", Addr_IndirY,      true,  8,     0,          false,          "Illegal" },
    /* 0xD4 */ { "SKB*", Addr_ZeroPageX,   true,  4,     0,          false,          "Illegal" },
    ...
    /* 0xD7 */ { "DCM*", Addr_ZeroPageX,   true,  6,     0,          false,          "Illegal" },
    ...
    /* 0xDB */ { "DCM*", Addr_AbslY,       true,  7,     0,          false,          "Illegal" },
    /* 0xDC */ { "SKW*", Addr_AbslX,       true,  4,     1,          false,          "Illegal" },
    ...
    /* 0xDF */ { "DCM*", Addr_AbslX,       true,  7,     0,          false,          "Illegal" },
    ...
    /* 0xE2 */ { "SKB*", Addr_Immediate,   true,  2,     0,          false,          "Illegal" },
    /* 0xE3 */ { "INS*", Addr_IndirX,      true, 8,     0,          false,          "Illegal" },
    ...
    /* 0xE7 */ { "INS*", Addr_ZeroPage,    true,  5,     0,          false,          "Illegal" },
    ...
    /* 0xEF */ { "INS*", Addr_Absolute,    true,  6,     0,          false,          "Illegal" },
    ...
    /* 0xF2 */ { "HLT*", Addr_Illegal,     true,  0,     0,          false,          "Illegal" },
    /* 0xF3 */ { "INS*", Addr_IndirY,      true,  8,     0,          false,          "Illegal" },
    /* 0xF4 */ { "SKB*", Addr_ZeroPageX,   true,  4,     0,          false,          "Illegal" },
    ...
    /* 0xF7 */ { "INS*", Addr_ZeroPageX,   true,  6,     0,          false,          "Illegal" },
    ...
    /* 0xFB */ { "INS*", Addr_AbslY,       true,  7,     0,          false,          "Illegal" },
    /* 0xFC */ { "SKW*", Addr_AbslX,       true,  4,     1,          false,          "Illegal" },
    ...
    /* 0xFF */ { "INS*", Addr_AbslX,       true,  7,     0,          false,          "Illegal" }
};
